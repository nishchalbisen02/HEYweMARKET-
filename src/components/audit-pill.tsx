...
export function AuditPill() {
  ...
  return (
    <div
      className={
        "fixed bottom-4 left-4 z-[90] flex max-w-[calc(100vw-2rem)] items-center gap-3 rounded-xl bg-night py-2.5 pl-4 pr-2.5 text-background shadow-soft-lg transition-transform duration-200 " +
    ...
    >
      ...
      <a
        href="#audit"
        className="inline-flex min-h-9 items-center rounded-lg bg-primary px-3.5 py-2 text-[12.5px] font-semibold text-primary-foreground"
      >
        Get mine
      </a>
      <button
